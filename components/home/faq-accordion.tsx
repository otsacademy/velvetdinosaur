...
export const CONTACT_FAQS = [
  ...
  },
  {
    ...
    answer:
      "Performance and security maintenance is £250/year after Year 1. Domain renewal is separate and procured at cost price. Keep ongoing support if you want it, or run the site independently with full access and handover documentation.",
  },
  {
