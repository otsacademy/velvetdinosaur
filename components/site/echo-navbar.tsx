...
function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="vd-theme-toggle inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[color-mix(in_oklch,var(--vd-border)_60%,transparent)] bg-background/72 text-[var(--vd-muted-fg)] transition-colors hover:text-[var(--vd-fg)]"
  ...
  return (
    <header className="supports-backdrop-filter:bg-background/60 fixed left-0 right-0 top-0 z-50 w-full backdrop-blur">
      <div className="mx-auto mt-4 max-w-6xl px-4 md:mt-6 md:px-6">
        <div className="flex items-center gap-2 rounded-full bg-background/82 p-2">
