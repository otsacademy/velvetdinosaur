...
import Block from "@/registry/new-york-v4/blocks/calendar-11";
...
export default function ShadcnBlockCalendar11({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
