...
import Block from "@/registry/new-york-v4/blocks/calendar-31";
...
export default function ShadcnBlockCalendar31({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
