...
import * as Registry from "@/registry/new-york-v4/ui/menubar";
...
export default function ShadcnMenubar({ label = "Menubar", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Menubar"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
