...
import Block from "@/registry/new-york-v4/blocks/otp-03/page";
...
export default function ShadcnBlockOtp03Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
