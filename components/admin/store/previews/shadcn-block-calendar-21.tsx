...
import Block from "@/registry/new-york-v4/blocks/calendar-21";
...
export default function ShadcnBlockCalendar21({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
