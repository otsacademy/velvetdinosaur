...
import Block from "@/registry/new-york-v4/blocks/sidebar-02/page";
...
export default function ShadcnBlockSidebar02Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
