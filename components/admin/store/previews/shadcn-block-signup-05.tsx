...
import Block from "@/registry/new-york-v4/blocks/signup-05/page";
...
export default function ShadcnBlockSignup05Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
