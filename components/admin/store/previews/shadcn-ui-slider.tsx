...
import * as Registry from "@/registry/new-york-v4/ui/slider";
...
export default function ShadcnSlider({ label = "Slider", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Slider"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
