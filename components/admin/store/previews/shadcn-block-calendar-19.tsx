...
import Block from "@/registry/new-york-v4/blocks/calendar-19";
...
export default function ShadcnBlockCalendar19({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
