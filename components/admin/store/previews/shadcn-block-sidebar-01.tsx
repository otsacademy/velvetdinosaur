...
import Block from "@/registry/new-york-v4/blocks/sidebar-01/page";
...
export default function ShadcnBlockSidebar01Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
