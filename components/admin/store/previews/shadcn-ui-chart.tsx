...
import * as Registry from "@/registry/new-york-v4/ui/chart";
...
export default function ShadcnChart({ label = "Chart", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Chart"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
