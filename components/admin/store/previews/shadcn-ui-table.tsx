...
import * as Registry from "@/registry/new-york-v4/ui/table";
...
export default function ShadcnTable({ label = "Table", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Table"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
