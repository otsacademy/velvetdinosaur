...
import Block from "@/registry/new-york-v4/blocks/calendar-07";
...
export default function ShadcnBlockCalendar07({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
