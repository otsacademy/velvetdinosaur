...
import Block from "@/registry/new-york-v4/blocks/sidebar-03/page";
...
export default function ShadcnBlockSidebar03Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
