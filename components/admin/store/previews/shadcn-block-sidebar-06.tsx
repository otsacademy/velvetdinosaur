...
import Block from "@/registry/new-york-v4/blocks/sidebar-06/page";
...
export default function ShadcnBlockSidebar06Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
