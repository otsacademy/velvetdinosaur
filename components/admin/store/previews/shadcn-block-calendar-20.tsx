...
import Block from "@/registry/new-york-v4/blocks/calendar-20";
...
export default function ShadcnBlockCalendar20({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
