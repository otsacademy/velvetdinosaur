...
import Block from "@/registry/new-york-v4/blocks/sidebar-10/page";
...
export default function ShadcnBlockSidebar10Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
