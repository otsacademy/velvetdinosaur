...
import Block from "@/registry/new-york-v4/blocks/calendar-04";
...
export default function ShadcnBlockCalendar04({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
