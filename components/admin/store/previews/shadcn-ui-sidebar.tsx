...
import * as Registry from "@/registry/new-york-v4/ui/sidebar";
...
export default function ShadcnSidebar({ label = "Sidebar", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Sidebar"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
