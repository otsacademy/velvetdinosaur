...
import Block from "@/registry/new-york-v4/blocks/calendar-08";
...
export default function ShadcnBlockCalendar08({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
