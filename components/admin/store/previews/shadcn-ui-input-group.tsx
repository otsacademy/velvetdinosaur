...
import * as Registry from "@/registry/new-york-v4/ui/input-group";
...
export default function ShadcnInputGroup({ label = "Input Group", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["InputGroup"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
