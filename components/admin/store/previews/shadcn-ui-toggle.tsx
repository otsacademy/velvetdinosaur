...
import * as Registry from "@/registry/new-york-v4/ui/toggle";
...
export default function ShadcnToggle({ label = "Toggle", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Toggle"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
