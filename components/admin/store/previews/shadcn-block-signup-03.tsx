...
import Block from "@/registry/new-york-v4/blocks/signup-03/page";
...
export default function ShadcnBlockSignup03Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
