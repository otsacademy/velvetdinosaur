...
import * as Registry from "@/registry/new-york-v4/ui/card";
...
export default function ShadcnCard({ label = "Card", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Card"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
