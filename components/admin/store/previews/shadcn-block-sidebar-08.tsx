...
import Block from "@/registry/new-york-v4/blocks/sidebar-08/page";
...
export default function ShadcnBlockSidebar08Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
