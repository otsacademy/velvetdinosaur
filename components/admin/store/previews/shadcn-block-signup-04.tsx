...
import Block from "@/registry/new-york-v4/blocks/signup-04/page";
...
export default function ShadcnBlockSignup04Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
