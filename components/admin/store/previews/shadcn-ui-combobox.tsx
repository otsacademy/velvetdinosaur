...
import * as Registry from "@/registry/new-york-v4/ui/combobox";
...
export default function ShadcnCombobox({ label = "Combobox", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Combobox"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
