...
import Block from "@/registry/new-york-v4/blocks/sidebar-04/page";
...
export default function ShadcnBlockSidebar04Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
