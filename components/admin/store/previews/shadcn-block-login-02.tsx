...
import Block from "@/registry/new-york-v4/blocks/login-02/page";
...
export default function ShadcnBlockLogin02Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
