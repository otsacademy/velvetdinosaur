...
import Block from "@/registry/new-york-v4/blocks/calendar-17";
...
export default function ShadcnBlockCalendar17({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
