...
import Block from "@/registry/new-york-v4/blocks/sidebar-05/page";
...
export default function ShadcnBlockSidebar05Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
