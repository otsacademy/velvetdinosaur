...
import Block from "@/registry/new-york-v4/blocks/login-04/page";
...
export default function ShadcnBlockLogin04Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
