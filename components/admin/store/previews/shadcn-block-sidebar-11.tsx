...
import Block from "@/registry/new-york-v4/blocks/sidebar-11/page";
...
export default function ShadcnBlockSidebar11Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
