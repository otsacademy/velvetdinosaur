...
import * as Registry from "@/registry/new-york-v4/ui/button";
...
export default function ShadcnButton({ label = "Button", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Button"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
