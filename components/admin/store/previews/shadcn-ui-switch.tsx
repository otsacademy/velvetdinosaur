...
import * as Registry from "@/registry/new-york-v4/ui/switch";
...
export default function ShadcnSwitch({ label = "Switch", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Switch"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
