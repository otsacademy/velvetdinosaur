...
import Block from "@/registry/new-york-v4/blocks/login-03/page";
...
export default function ShadcnBlockLogin03Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
