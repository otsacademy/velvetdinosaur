...
import * as Registry from "@/registry/new-york-v4/ui/native-select";
...
export default function ShadcnNativeSelect({ label = "Native Select", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["NativeSelect"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
