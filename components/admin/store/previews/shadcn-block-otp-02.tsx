...
import Block from "@/registry/new-york-v4/blocks/otp-02/page";
...
export default function ShadcnBlockOtp02Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
