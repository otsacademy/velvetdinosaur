...
import Block from "@/registry/new-york-v4/blocks/calendar-13";
...
export default function ShadcnBlockCalendar13({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
