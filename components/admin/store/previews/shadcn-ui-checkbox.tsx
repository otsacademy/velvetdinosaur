...
import * as Registry from "@/registry/new-york-v4/ui/checkbox";
...
export default function ShadcnCheckbox({ label = "Checkbox", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Checkbox"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
