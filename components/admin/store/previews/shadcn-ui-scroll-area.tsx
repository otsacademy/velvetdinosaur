...
import * as Registry from "@/registry/new-york-v4/ui/scroll-area";
...
export default function ShadcnScrollArea({ label = "Scroll Area", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["ScrollArea"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
