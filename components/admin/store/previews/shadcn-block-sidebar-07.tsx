...
import Block from "@/registry/new-york-v4/blocks/sidebar-07/page";
...
export default function ShadcnBlockSidebar07Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
