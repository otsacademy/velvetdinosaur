...
import Block from "@/registry/new-york-v4/blocks/calendar-02";
...
export default function ShadcnBlockCalendar02({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
