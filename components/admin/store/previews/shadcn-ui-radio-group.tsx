...
import * as Registry from "@/registry/new-york-v4/ui/radio-group";
...
export default function ShadcnRadioGroup({ label = "Radio Group", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["RadioGroup"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
