...
import * as Registry from "@/registry/new-york-v4/ui/command";
...
export default function ShadcnCommand({ label = "Command", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Command"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
