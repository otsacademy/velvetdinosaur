...
import Block from "@/registry/new-york-v4/blocks/login-01/page";
...
export default function ShadcnBlockLogin01Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
