...
import * as Registry from "@/registry/new-york-v4/ui/empty";
...
export default function ShadcnEmpty({ label = "Empty", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Empty"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
