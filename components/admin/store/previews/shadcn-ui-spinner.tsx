...
import * as Registry from "@/registry/new-york-v4/ui/spinner";
...
export default function ShadcnSpinner({ label = "Spinner", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Spinner"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
