...
import * as Registry from "@/registry/new-york-v4/ui/skeleton";
...
export default function ShadcnSkeleton({ label = "Skeleton", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Skeleton"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
