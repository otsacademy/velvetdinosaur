...
import * as Registry from "@/registry/new-york-v4/ui/collapsible";
...
export default function ShadcnCollapsible({ label = "Collapsible", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Collapsible"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
