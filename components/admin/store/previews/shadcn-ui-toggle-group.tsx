...
import * as Registry from "@/registry/new-york-v4/ui/toggle-group";
...
export default function ShadcnToggleGroup({ label = "Toggle Group", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["ToggleGroup"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
