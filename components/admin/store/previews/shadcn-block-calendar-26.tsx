...
import Block from "@/registry/new-york-v4/blocks/calendar-26";
...
export default function ShadcnBlockCalendar26({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
