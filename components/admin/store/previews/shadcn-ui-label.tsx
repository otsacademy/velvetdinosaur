...
import * as Registry from "@/registry/new-york-v4/ui/label";
...
export default function ShadcnLabel({ label = "Label", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Label"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
