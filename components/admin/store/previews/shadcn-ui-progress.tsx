...
import * as Registry from "@/registry/new-york-v4/ui/progress";
...
export default function ShadcnProgress({ label = "Progress", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Progress"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
