...
import * as Registry from "@/registry/new-york-v4/ui/input";
...
export default function ShadcnInput({ label = "Input", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Input"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
