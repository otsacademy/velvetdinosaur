...
import * as Registry from "@/registry/new-york-v4/ui/drawer";
...
export default function ShadcnDrawer({ label = "Drawer", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Drawer"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
