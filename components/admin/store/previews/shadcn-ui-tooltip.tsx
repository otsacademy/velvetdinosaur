...
import * as Registry from "@/registry/new-york-v4/ui/tooltip";
...
export default function ShadcnTooltip({ label = "Tooltip", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Tooltip"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
