...
import Block from "@/registry/new-york-v4/blocks/calendar-15";
...
export default function ShadcnBlockCalendar15({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
