...
import Block from "@/registry/new-york-v4/blocks/calendar-12";
...
export default function ShadcnBlockCalendar12({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
