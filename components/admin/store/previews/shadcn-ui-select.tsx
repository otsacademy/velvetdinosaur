...
import * as Registry from "@/registry/new-york-v4/ui/select";
...
export default function ShadcnSelect({ label = "Select", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Select"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
