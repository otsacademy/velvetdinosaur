...
import * as Registry from "@/registry/new-york-v4/ui/calendar";
...
export default function ShadcnCalendar({ label = "Calendar", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Calendar"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
