...
import Block from "@/registry/new-york-v4/blocks/calendar-24";
...
export default function ShadcnBlockCalendar24({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
