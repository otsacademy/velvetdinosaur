...
import Block from "@/registry/new-york-v4/blocks/calendar-06";
...
export default function ShadcnBlockCalendar06({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
