...
import * as Registry from "@/registry/new-york-v4/ui/aspect-ratio";
...
export default function ShadcnAspectRatio({ label = "Aspect Ratio", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["AspectRatio"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
