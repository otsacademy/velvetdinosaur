...
import Block from "@/registry/new-york-v4/blocks/dashboard-01/page";
...
export default function ShadcnBlockDashboard01Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
