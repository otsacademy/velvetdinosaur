...
import Block from "@/registry/new-york-v4/blocks/sidebar-09/page";
...
export default function ShadcnBlockSidebar09Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
