...
import * as Registry from "@/registry/new-york-v4/ui/pagination";
...
export default function ShadcnPagination({ label = "Pagination", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Pagination"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
