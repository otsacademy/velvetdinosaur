...
import Block from "@/registry/new-york-v4/blocks/calendar-30";
...
export default function ShadcnBlockCalendar30({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
