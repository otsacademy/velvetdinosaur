...
import * as Registry from "@/registry/new-york-v4/ui/hover-card";
...
export default function ShadcnHoverCard({ label = "Hover Card", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["HoverCard"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
