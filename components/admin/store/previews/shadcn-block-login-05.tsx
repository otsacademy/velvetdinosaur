...
import Block from "@/registry/new-york-v4/blocks/login-05/page";
...
export default function ShadcnBlockLogin05Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
