...
import Block from "@/registry/new-york-v4/blocks/sidebar-15/page";
...
export default function ShadcnBlockSidebar15Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
