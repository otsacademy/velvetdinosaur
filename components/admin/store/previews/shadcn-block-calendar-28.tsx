...
import Block from "@/registry/new-york-v4/blocks/calendar-28";
...
export default function ShadcnBlockCalendar28({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
