...
import Block from "@/registry/new-york-v4/blocks/calendar-27";
...
export default function ShadcnBlockCalendar27({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
