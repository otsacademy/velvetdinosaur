...
import Block from "@/registry/new-york-v4/blocks/otp-01/page";
...
export default function ShadcnBlockOtp01Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
