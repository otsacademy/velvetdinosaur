...
import Block from "@/registry/new-york-v4/blocks/calendar-01";
...
export default function ShadcnBlockCalendar01({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
