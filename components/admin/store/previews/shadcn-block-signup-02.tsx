...
import Block from "@/registry/new-york-v4/blocks/signup-02/page";
...
export default function ShadcnBlockSignup02Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
