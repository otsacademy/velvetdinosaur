...
import Block from "@/registry/new-york-v4/blocks/otp-04/page";
...
export default function ShadcnBlockOtp04Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
