...
import Block from "@/registry/new-york-v4/blocks/calendar-03";
...
export default function ShadcnBlockCalendar03({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
