...
import Block from "@/registry/new-york-v4/blocks/signup-01/page";
...
export default function ShadcnBlockSignup01Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
