...
import * as Registry from "@/registry/new-york-v4/ui/alert";
...
export default function ShadcnAlert({ label = "Alert", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Alert"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
