...
import * as Registry from "@/registry/new-york-v4/ui/popover";
...
export default function ShadcnPopover({ label = "Popover", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Popover"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
