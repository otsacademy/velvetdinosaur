...
import Block from "@/registry/new-york-v4/blocks/sidebar-14/page";
...
export default function ShadcnBlockSidebar14Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
