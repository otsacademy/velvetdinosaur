...
import Block from "@/registry/new-york-v4/blocks/calendar-23";
...
export default function ShadcnBlockCalendar23({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
