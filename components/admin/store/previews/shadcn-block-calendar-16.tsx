...
import Block from "@/registry/new-york-v4/blocks/calendar-16";
...
export default function ShadcnBlockCalendar16({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
