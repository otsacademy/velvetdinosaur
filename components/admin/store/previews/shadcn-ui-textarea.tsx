...
import * as Registry from "@/registry/new-york-v4/ui/textarea";
...
export default function ShadcnTextarea({ label = "Textarea", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Textarea"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
