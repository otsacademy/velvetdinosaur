...
import Block from "@/registry/new-york-v4/blocks/calendar-32";
...
export default function ShadcnBlockCalendar32({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
