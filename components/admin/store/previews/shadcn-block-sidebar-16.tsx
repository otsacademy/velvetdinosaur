...
import Block from "@/registry/new-york-v4/blocks/sidebar-16/page";
...
export default function ShadcnBlockSidebar16Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
