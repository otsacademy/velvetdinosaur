...
import Block from "@/registry/new-york-v4/blocks/calendar-10";
...
export default function ShadcnBlockCalendar10({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
