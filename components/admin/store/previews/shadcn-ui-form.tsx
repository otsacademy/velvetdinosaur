...
import * as Registry from "@/registry/new-york-v4/ui/form";
...
export default function ShadcnForm({ label = "Form", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Form"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
