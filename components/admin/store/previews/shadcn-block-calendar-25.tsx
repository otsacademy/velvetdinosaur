...
import Block from "@/registry/new-york-v4/blocks/calendar-25";
...
export default function ShadcnBlockCalendar25({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
