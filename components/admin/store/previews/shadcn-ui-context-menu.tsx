...
import * as Registry from "@/registry/new-york-v4/ui/context-menu";
...
export default function ShadcnContextMenu({ label = "Context Menu", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["ContextMenu"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
