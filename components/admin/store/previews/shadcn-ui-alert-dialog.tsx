...
import * as Registry from "@/registry/new-york-v4/ui/alert-dialog";
...
export default function ShadcnAlertDialog({ label = "Alert Dialog", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["AlertDialog"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
