...
import Block from "@/registry/new-york-v4/blocks/calendar-22";
...
export default function ShadcnBlockCalendar22({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
