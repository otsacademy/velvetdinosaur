...
import Block from "@/registry/new-york-v4/blocks/calendar-09";
...
export default function ShadcnBlockCalendar09({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
