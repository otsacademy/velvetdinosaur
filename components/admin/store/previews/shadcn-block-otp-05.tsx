...
import Block from "@/registry/new-york-v4/blocks/otp-05/page";
...
export default function ShadcnBlockOtp05Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
