...
import Block from "@/registry/new-york-v4/blocks/sidebar-12/page";
...
export default function ShadcnBlockSidebar12Page({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
