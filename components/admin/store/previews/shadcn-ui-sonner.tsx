...
import * as Registry from "@/registry/new-york-v4/ui/sonner";
...
export default function ShadcnSonner({ label = "Sonner", className = "", propsJson = "" }: PrimitiveProps) {
  const resolved = (Registry as Record<string, unknown>)["Sonner"] || (Registry as Record<string, unknown>).default || Object.values(Registry as Record<string, unknown>).find((value) => typeof value === "function");
