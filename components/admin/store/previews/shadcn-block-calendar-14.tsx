...
import Block from "@/registry/new-york-v4/blocks/calendar-14";
...
export default function ShadcnBlockCalendar14({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
