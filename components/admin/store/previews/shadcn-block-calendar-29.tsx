...
import Block from "@/registry/new-york-v4/blocks/calendar-29";
...
export default function ShadcnBlockCalendar29({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
