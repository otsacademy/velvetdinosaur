...
import Block from "@/registry/new-york-v4/blocks/calendar-18";
...
export default function ShadcnBlockCalendar18({ className = "", propsJson = "", ...props }: BlockProps & Record<string, unknown>) {
