...
import { StaysVideoCarouselView } from './stays-video-carousel.client';

export type StaysVideoCarouselProps = {
  title?: string;
  accent?: string;
  videoSlugs?: string[];
};

export async function StaysVideoCarousel(props: StaysVideoCarouselProps) {
  ...
  return <StaysVideoCarouselView title={props.title} accent={props.accent} videos={videos} />;
}

export const staysVideoCarouselConfig: ComponentConfig<StaysVideoCarouselProps> = {
  fields: {
    title: { type: 'text' },
    accent: { type: 'text' },
  ...
  render: (props) => StaysVideoCarousel(props) as any
};
