...
export const feature14Config: ComponentConfig<Feature14BlockProps> = {
  ...
  defaultProps: {
    ...
    items: [
      ...
      {
        title: "Tailored handover",
        description:
          "Every project includes a practical handover so you know what you can update yourself and when it makes sense to send changes back to me.",
        bullets: [
          "Short walkthrough once the site is live",
          "Clear guidance on copy, images, and sections",
          "Backups in place before major edits",
        ],
        image: assetUrl("placeholder.jpg"),
        imageAlt: "Site handover overview",
        badge: "03",
        ctaLabel: "",
        ctaHref: "",
      },
