...
import { supportModuleLabel, supportWaitingOnLabel } from '@/lib/support/constants';
import type { SupportTicketSummary } from '@/components/edit/support/support-workspace.shared';
import { formatDateTime } from '@/components/edit/support/support-workspace.shared';
...
export function SupportTicketTable({ tickets, selectedTicketId, isLoading, onSelectTicket }: SupportTicketTableProps) {
  return (
            ...
            tickets.map((ticket) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-3 py-2">
                    <Badge variant="outline" className={waitingBadgeClass(ticket.waitingOn)}>
                      {supportWaitingOnLabel(ticket.waitingOn)}
                    </Badge>
                  </td>
