...
import { SUPPORT_TICKET_CATEGORIES, SUPPORT_TICKET_MODULES } from '@/lib/support/constants';
import type { TicketCreateState } from '@/components/edit/support/support-workspace.shared';
...
const PROBLEM_CATEGORY_KEYS: TicketCreateState['category'][] = [
  'support_request',
  'content_update',
  'technical_issue'
];
  ...
  return (
    <Card className="max-w-3xl">
      <CardHeader>
        ...
        <CardDescription>
          {isFeatureMode
            ? "Tell us what you'd like to add or improve. We'll review and confirm if a quote is needed."
            : "Tell us what's broken or what needs updating on your website."}
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="Briefly describe what you need, e.g. Update staff photo on About page"
          />
        </div>

        {isFeatureMode ? (
          <div className="rounded-md border border-border/80 bg-muted/30 p-3 text-sm text-muted-foreground">
            New features may require additional development work. We&apos;ll review your request and provide a quote if
            needed.
          </div>
        ) : (
          <div className="space-y-2">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            {PRIORITY_OPTIONS.find((item) => item.value === createState.priority)?.description ||
        ...
        <div className="space-y-2">
          ...
          />
          <p className="text-xs text-muted-foreground">If this is time-sensitive, let us know when you need it done by.</p>
        </div>
        ...
        <div className="space-y-2">
          ...
          />
          <p className="text-xs text-muted-foreground">
            If you can, paste the web address of the page with the issue (copy it from your browser&apos;s address bar).
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            placeholder="Please describe what you need in as much detail as possible. If something looks wrong, describing what you see and what you expected is really helpful."
          />
        </div>
