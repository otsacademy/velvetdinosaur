...
import type { SupportOverview, SupportTicketSummary } from '@/components/edit/support/support-workspace.shared';
...
export function SupportDashboard({ overview, onSelectRecentTicket }: SupportDashboardProps) {
  return (
