...
assertServerOnly('models/NewsArticle.ts')
...
NewsArticleSchema.index({ status: 1, tag: 1, publishedAt: -1, createdAt: -1 })
NewsArticleSchema.index({ sourcePostId: 1 }, { unique: true, sparse: true })
NewsArticleSchema.index({ sourceSlug: 1 }, { sparse: true })
