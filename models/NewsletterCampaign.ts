...
const NewsletterCampaignSchema = new Schema(
  {
    ...
    bodySource: { type: String, enum: ['visual', 'html', 'text'] },
    attachments: { type: [Schema.Types.Mixed], default: [] },
    frozenContent: { type: Schema.Types.Mixed, default: null },
    preparationToken: { type: String, default: null },
    preparationStartedAt: { type: Date, default: null },
    dispatchLeaseToken: { type: String, default: null },
    dispatchLeaseUntil: { type: Date, default: null },
